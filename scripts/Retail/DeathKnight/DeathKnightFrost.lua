...
M:DefineSettings({
    ...
    { type = "header", label = "Required: Breath of Sindragosa, Reaper's Mark, Exterminate", labelZh = "※ 核心必要天赋: 冰龙吐息、死神印记、破灭" },
    { type = "header", label = "Optional: Frostscythe, Glacial Advance", labelZh = "※ 可选AOE天赋: 冰霜之镰、冰川突进" },
